  ...
  return (
    <div className="keyboard">
      <div className="keyboard-row">
        <KeyboardButton color="#d3d6da" text="Enter" onClick={() => onSubmit()} disabled={disableSubmit}/>
        ...
        <KeyboardButton color="#d3d6da" text="Back" onClick={() => onDelete()} disabled={disableDelete}/>
      </div>
      <div className="keyboard-row">
      </div>
    </div>
